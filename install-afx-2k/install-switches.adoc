...
summary: Informationen zur Installation der Switches für das AFX 2K Storage System und die Storage Shelves. 
---
= Die Switches für Ihr AFX 2K Storage-System installieren
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Nachdem Sie die Vorbereitungen für die Installation des AFX 2K Speichersystems abgeschlossen haben, sollten die Switches im Schrank oder im Telco-Rack installiert werden.
...
NOTE: Wenn der Luftstrom Ihrer Switches für die Portseite als Lufteinlass konfiguriert ist (weinrote Lüfter und Netzteile), müssen die Netzwerkports der Switches zur Vorderseite des Schranks installiert werden und die Abluftlüfter zur Rückseite des Schranks zeigen. Mit dieser Konfiguration ist sicherzustellen, dass ausreichend lange Kabel verwendet werden, um von den Netzwerkports an der Vorderseite des Schranks zu den Storage-Ports an der Rückseite des Schranks zu gelangen. + Ausführlichere Informationen zu diesen Switches sind auf der Cisco Website verfügbar: link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-modular-overview-ph2.html["Cisco Nexus 9808 Mode Switch Hardware-Installationshandbuch"^], link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9332D-GX2B Mode Switch Hardware-Installationshandbuch"^] und link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9364D-GX2A Mode Switch Hardware-Installationshandbuch"^].
...
== Installation des Cisco Nexus 9808 Switches

Wenn Sie den Cisco Nexus 9808 Switch installieren, finden Sie im link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-install-chassis.html["Cisco Nexus 9808 Mode Switch Hardware-Installationshandbuch"^] detaillierte Anweisungen zur Installation der Switches im Schrank oder Rack.



[[cisco-nexus-9332d-gx2b-and-9364d-gx2a-switch-installation]]
== Cisco Nexus 9332D-GX2B und 9364D-GX2A Switch Installation

Wenn Sie Cisco Nexus 9332D-GX2B oder 9364D installieren, sind die folgenden Schritte zur Installation der Switches im Schrank oder Rack auszuführen.
...
.. Die Buchsen beider Überbrückungskabel werden von der Rückseite des Panels durch die Bürstenbaugruppe geführt.
+
...
+
Die beiden Switches sind an Schrankpositionen zu montieren, die einen effizienten Zugriff auf Controller und Shelves ermöglichen, beispielsweise in den mittleren Reihen.
...
.Wie geht es weiter?
Nachdem Sie die Schalter im Schrank oder Rack installiert haben, link:deploy-hardware.html["Das AFX 2K Storage System und die Shelves im Schrank oder Rack installieren"].
