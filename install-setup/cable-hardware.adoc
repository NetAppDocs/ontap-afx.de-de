...
+
Bei einer gegebenen 4x100GbE-Breakout-Kabelverbindung zu dem jeweiligen Switch-Port werden alle vier Ports eines bestimmten Controllers über dieses eine Breakout-Kabel mit dem Switch verbunden.

+
** 1 x HA-Port (Steckplatz 1)
** 1 x Cluster-Port (Steckplatz 7)
** 2 x Speicheranschlüsse (Steckplätze 10, 11)
+
...
* Die gemischte Verwendung von Kupfer- und optischen Breakout-Verbindungen (Kabeln) wird von NVIDIA C6X-DX und CX7 (100GbE) NIC-Adaptern nicht unterstützt. Es sollten entweder ausschließlich Kupfer- oder ausschließlich optische Verbindungen verwendet werden, eine Kombination verschiedener Verbindungstypen ist zu vermeiden. Das Mischen der Verbindungstypen kann nach längerer Nutzung zu einer Sättigung der Verbindung führen.
+
Stellen Sie sicher, dass die richtigen Kabel für Ihren Anschlusstyp vorhanden sind, bevor die Switches verkabelt werden.

+

NOTE: Weitere Informationen zum Mischen von Verbindungstypen enthält der NetApp Knowledge Base Artikel link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-Issues/CHW-3504["CRC-Link-Fehler treten auf der CX6-DX NIC mit gemischten Kupfer- und Glasfaser-Breakout-Kabeln an den Ports auf"^].
...
image::../media/drw_afx_management_connection_ieops-2815.svg[Stellen Sie eine Verbindung zu Ihrem Verwaltungsnetzwerk her]
...
+
image::../media/drw_afx_network_cabling_a_ieops-2813.svg[Kabel zum Ethernet-Netzwerk]
...
+
image::../media/drw_afx_network_cabling_b_ieops-2814.svg[Kabel zum Ethernet-Netzwerk]
...
== Schritt 3: Verkabeln Sie die Cluster-, HA- und Speicherverbindungen mit Switch A

Verwenden Sie das 4x100GbE-Breakout-Kabel, um die Cluster-, HA- und Speicherports der Controller mit Netzwerk-Switch A zu verbinden. Verwenden Sie das Cluster- und HA-Interconnect-Kabel, um die Ports e1a und e7a mit Switch A zu verbinden. Die Ports e1a werden für die HA-Verbindungen verwendet, und die Ports e7a werden für die Cluster-Verbindungen verwendet. Für die Speicherverbindungen verbinden Sie die Ports e10a und e11a mit Switch A.

Stellen Sie sicher, dass Sie die richtigen Kabel und Stecker für Ihre Switches haben. Siehe  https://hwu.netapp.com["Hardware Universe"^] für weitere Informationen.

.Schritte
. Verbinden Sie die folgenden Controller-Ports mit einem beliebigen Nicht-ISL-Port am Netzwerk-Switch A.
+
** Controller
+
*** e1a (HA)
...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[Kabelcontroller-Cluster,800px,and storage to switch A]
...
== Schritt 4: Verkabeln Sie die Cluster-, HA- und Speicherverbindungen mit Switch B

Verwenden Sie das 4x100GbE-Breakout-Kabel, um die Cluster-, HA- und Speicherports der Controller mit Netzwerk-Switch B zu verbinden. Verwenden Sie das Cluster- und HA-Interconnect-Kabel, um die Ports e1b und e7b mit Switch B zu verbinden. Die Ports e1b werden für die HA-Verbindungen verwendet, und die Ports e7b werden für die Cluster-Verbindungen verwendet. Für die Speicherverbindungen verbinden Sie die Ports e10b und e11b mit Switch B.

Stellen Sie sicher, dass Sie die richtigen Kabel und Stecker für Ihre Switches haben. Siehe  https://hwu.netapp.com["Hardware Universe"^] für weitere Informationen.

. Verbinden Sie die folgenden Controller-Ports mit einem beliebigen Nicht-ISL-Port am Netzwerk-Switch B.
+
** Controller
+
*** e1b (HA)
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[Kabelcontroller-Cluster,800px,and storage to switch B]
