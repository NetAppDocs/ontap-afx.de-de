...
NOTE: Wenn Sie AFX 1K mit der AI Data Engine (AIDE) einsetzen, installieren Sie die AIDE Datenrechenknoten nach dem Einschalten des AFX-Systems. Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Installieren Sie AIDE Data Compute Nodes"].
