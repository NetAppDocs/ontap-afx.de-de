...
* Für AFX 1K mit AI Data Engine (AIDE)-Bereitstellungen gehen Sie zu link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Installieren Sie AIDE Data Compute Nodes"].
