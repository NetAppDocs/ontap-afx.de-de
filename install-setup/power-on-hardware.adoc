...
.Wie geht es weiter?
Nach dem Einschalten Ihres AFX 1K Storage-Systems schließen Sie die Einrichtung entsprechend Ihrer Bereitstellungsoption ab:

* Für dedizierte AFX 1K-Speichersystembereitstellungen gehen Sie zu link:../install-setup/cluster-setup.html["Richten Sie einen AFX-Cluster ein"].
* Für AFX 1K mit AI Data Engine (AIDE)-Bereitstellungen installieren Sie AIDE-Drittanbieterserver oder NetApp-bereitgestellte Datenrechenknoten:
