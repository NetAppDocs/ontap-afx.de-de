...
Bei der erstmaligen Installation und Einrichtung von AFX können Sie optional NetApp AI Data Engine (AIDE) einbinden. Wenn Sie planen, AIDE einzurichten, müssen Sie zunächst Folgendes tun:

* Stellen Sie sicher, dass  https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["AIDE installieren"^] und die Rechenknoten an das AFX-Speichernetzwerk angeschlossen sind.
* Ermitteln Sie die Adressen und alle zugehörigen Netzwerkkonfigurationen für die Datenrechenknoten.
...
. Wenn Sie AI Data Engine mit Ihrem AFX-Speichersystem installieren, geben Sie die IP-Adressen für die drei AIDE DCN Nodes an.
...
.Was kommt als nächstes
* Wenn Sie AIDE als Teil der AFX-Cluster-Einrichtung eingeschlossen haben, müssen Sie zusätzliche Konfigurationsschritte durchführen, einschließlich Lizenzierung und Authentifizierung. Siehe  https://docs.netapp.com/us-en/ai-data-engine/install-setup/cluster-setup-afx.html["AI Data Engine einrichten"^] für weitere Informationen.
