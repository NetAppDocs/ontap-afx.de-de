...
NetApp AFX ist für leistungsstarke NAS- und Objekt-Workloads optimiert. Daher bestehen Unterschiede zu AFF und FAS Storage-Systemen. Die folgenden Funktionen sind bei NetApp AFX nicht verfügbar; die Liste ist nach Hauptfunktionen oder Funktionsbereichen geordnet. Sie sollten außerdem die Aktualisierungen und Änderungen für AFX in link:../release-notes/whats-new-9171.html["Was ist neu"] basierend auf Ihrer ONTAP-Version überprüfen.
