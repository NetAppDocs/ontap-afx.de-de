...
Controllerknoten pro Cluster:: Jeder AFX Cluster muss mindestens vier Knoten umfassen. Die maximale Anzahl an Knoten variiert je nach ONTAP Version; beispielsweise erlaubt die Version 9.19.1 bis zu 32 Knoten pro AFX Cluster.
