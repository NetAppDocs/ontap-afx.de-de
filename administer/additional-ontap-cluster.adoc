...
[role="lead"]
Zusätzlich zur typischen AFX Cluster-Administration können je nach Umgebung weitere Aufgaben erforderlich sein. Die meisten dieser zusätzlichen Aufgaben lassen sich mit System Manager ausführen, in einigen Fällen ist jedoch die Nutzung der CLI erforderlich. Die beschriebenen ONTAP Funktionen und Administrationsschritte gelten sowohl für AFX Speichersysteme als auch für AFF oder FAS Systeme mit Unified ONTAP. Links zur entsprechenden Unified ONTAP Dokumentation sind gegebenenfalls enthalten.
...
* https://docs.netapp.com/us-en/ontap/networking/ipsec-prepare.html["Vorbereitung auf die Verwendung von IP-Sicherheit im ONTAP Netzwerk"^]
* https://docs.netapp.com/us-en/ontap/networking/configure_network_security_using_federal_information_processing_standards_fips.html["ONTAP Netzwerksicherheit mit FIPS für alle SSL-Verbindungen konfigurieren"^]
